...
public class AppController implements Initializable {
    ...
    private void setPlatformApplicationMenu() {
        ...
        if(platform == org.controlsfx.tools.Platform.OSX) {
            ...
            Menu defaultApplicationMenu = new Menu("Apple", null, tk.createAboutMenuItem(AshigaruTerminal.APP_NAME, getAboutStage()), new SeparatorMenuItem(),
                    preferences, new SeparatorMenuItem(),
                    tk.createHideMenuItem(AshigaruTerminal.APP_NAME), tk.createHideOthersMenuItem(), tk.createUnhideAllMenuItem(), new SeparatorMenuItem(),
                    tk.createQuitMenuItem(AshigaruTerminal.APP_NAME));
    ...
    private Stage getAboutStage() {
        try {
            ...
            stage.setTitle("About " + AshigaruTerminal.APP_NAME);
    ...
    public void openWalletFile(File file, boolean forceSameWindow) {
        try {
            ...
            if(e instanceof IOException && e.getMessage().startsWith("The process cannot access the file because another process has locked")) {
                ...
                showErrorDialog("Error Opening Wallet", "The wallet file is locked. Is another instance of " + AshigaruTerminal.APP_NAME + " already running?");
            } else if(!attemptImportWallet(file, null)) {
                log.error("Error opening wallet", e);
