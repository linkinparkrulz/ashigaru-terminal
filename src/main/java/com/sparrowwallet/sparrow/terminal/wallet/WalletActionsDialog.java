...
public class WalletActionsDialog extends DialogWindow {
    ...
    public WalletActionsDialog(String walletId) {
        ...
        buttonPanel.addComponent(new Button("Main Menu", this::onCancel).setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.CENTER, true, false)));
