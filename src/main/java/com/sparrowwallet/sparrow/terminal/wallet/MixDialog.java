...
public class MixDialog extends WalletDialog {
    ...
    public MixDialog(String walletId, WalletForm walletForm, List<UtxoEntry> utxoEntries) {
        ...
        //Allow only high fee priority
        //FEE_PRIORITIES.forEach(premixPriority::addItem);
        premixPriority.addItem(FEE_PRIORITIES.get(2));
        ...
        premixPriority.setSelectedIndex(0);
    ...
    private void onNext() {
        try {
            ...
            Platform.runLater(() -> showErrorDialog("Error fetching pools", "Could not connect to Zerolink Server"));
        }
