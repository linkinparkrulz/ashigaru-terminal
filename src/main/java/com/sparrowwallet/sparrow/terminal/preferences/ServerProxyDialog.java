...
public abstract class ServerProxyDialog extends DialogWindow {
    ...
    protected void addProxyComponents(Panel mainPanel) {
        ...
        proxyHost = new TextBox().setValidationPattern(Pattern.compile("[a-zA-Z0-9.]+"));
        mainPanel.addComponent(proxyHost, GridLayout.createLayoutData(
        ...
        mainPanel.addComponent(new Label("Proxy Port"));
