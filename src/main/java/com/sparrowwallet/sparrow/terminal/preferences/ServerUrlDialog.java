...
public abstract class ServerUrlDialog extends ServerProxyDialog {
    ...
    protected void addUrlComponents(Panel mainPanel, List<Server> recentServers, Server configuredServer) {
        mainPanel.addComponent(new Label("Server URL"));
        host = new ComboBox<>();
        host.setReadOnly(false);
        mainPanel.addComponent(host, GridLayout.createLayoutData(
        ...
        mainPanel.addComponent(new Label("Server Port"));
        ...
        mainPanel.addComponent(new Label("Nickname (optional)"));
